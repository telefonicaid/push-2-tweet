 ...
 * @type {{OPERATION_ACTION: string, INTERACTION_TYPE: string, INTERACTION_TYPES: {SYNCHRONOUS: string,
 * ASYNCHRONOUS: string}, OPERATION_EXTRA: string, UNICA_CORRELATOR_HEADER: string,
...
/**
 * Twitter possible status list configuration
 * @type {string}
 */
module.exports.TWITTER_STATUS_LIST = config.twitter.status;
